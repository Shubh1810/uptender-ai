...
export function Footer({ className = '' }: FooterProps) {
  return (
    <footer className={`bg-[#0a0a1a] text-white py-12 px-4 sm:px-6 lg:px-8 ${className}`}>
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h4 className="font-semibold mb-4 text-white">Tender Categories</h4>
          ...
          <div className="md:order-4">
            ...
            <ul className="space-y-2 text-sm text-gray-300">
              <li>
                ...
                <a href="tel:+919821944444" className="ml-2 hover:text-white transition-colors">+91 98219 44444</a>
              </li>
              <li>
              ...
              <li>
                ...
                <a href="mailto:sales@tenderpost.org" className="ml-2 hover:text-white transition-colors">sales@tenderpost.org</a>
              </li>
            </ul>
          </div>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 text-gray-300">
