      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 px-3 py-2 space-y-1 overflow-y-auto glass-scrollbar">
                        ...
                        return (
                          <Link
                            ...
                            className={`flex items-center space-x-2.5 px-3 py-1.5 text-sm rounded-lg transition-all duration-150 ${
                              isActive
                                ? 'bg-[#fefcf3] dark:bg-orange-900/20 text-gray-800 dark:text-orange-400 font-medium'
                                : 'text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 hover:bg-[#fefcf3]/80 dark:hover:bg-white/5'
                            }`}
                          >
            ...
            <div className="h-px bg-[#d4d0be]/50 dark:bg-gray-700/50 my-3" />
            ...
            >
              {user.user_metadata?.avatar_url ? (
                <Image
                  ...
                  width={36}
                  height={36}
                  className="w-9 h-9 rounded-full object-cover ring-2 ring-[#dddac8]"
                />
              ) : (
                <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[#9a8878] to-[#6b5a4a] flex items-center justify-center text-white text-sm font-semibold ring-2 ring-[#dddac8]">
            ...
            {userMenuOpen && (
              <div className="absolute bottom-full left-3 right-3 mb-2 glass-dropdown py-1 z-50">
                <button
                  ...
                  className="w-full flex items-center space-x-2 px-4 py-2.5 text-sm text-gray-700 hover:bg-[#fefcf3] transition-colors first:rounded-t-lg"
                >
                  <Settings className="h-4 w-4" />
                  <span>Settings</span>
                </button>
                <div className="h-px bg-[#d4d0be]/50 my-1 mx-2" />
                <button
                  onClick={() => {
                    setUserMenuOpen(false);
                    handleSignOut();
